...
define("utils/common_utils", function() {});
...
define('modules/authentication', [], function() {
    var Auth = function() {
            function login() {
            ...
            function authenticateAccount() {
                ...
                // get socket + contact server

                // (callback) store email + account information
            }
...
var tests = ['deps/jasmine/jasmine-html', 'tests/checks', ]
...
require(['jquery', 'utils/common_utils', 'utils/utils', 'utils/sync', 'modules/authentication'], function($, CUtils, Utils, Sync, Auth) {
    Utils.initDebug()
    Auth.login()
    //    Sync.init()
    if (Utils.inTestMode()) {
